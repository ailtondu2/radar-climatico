...
Painel web para consultar temperaturas máximas e mínimas previstas em municípios brasileiros.
...
- Gráfico responsivo de máximas e mínimas
- Resumo do pico de máxima, menor mínima e amplitude média
...
- `app.js` — integração com IBGE e Open-Meteo, filtros e gráfico